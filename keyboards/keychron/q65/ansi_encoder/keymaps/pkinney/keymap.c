...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [MAC_BASE] = LAYOUT_ansi_73(
        KC_MUTE, KC_GRV,  KC_1,     KC_2,     KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,     KC_MINS,  KC_EQL,   KC_BSPC,          KC_DEL,
        HYPR(KC_F1), KC_TAB,  KC_Q,     KC_W,     KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,     KC_LBRC,  KC_RBRC,  KC_BSLS,          HYPR(KC_F6),
        HYPR(KC_F2), CTL_T(KC_ESC), KC_A,     KC_S,     KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN,  KC_QUOT,            KC_ENT,           HYPR(KC_F7),
        HYPR(KC_F3), KC_LSFT,           KC_Z,     KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,   KC_SLSH,            KC_RSFT, KC_UP,   HYPR(KC_F8),
        HYPR(KC_F4), KC_LCTL, KC_LOPT,  KC_LCMD,                             KC_SPC,                             KC_MEH,  KC_HYPR, MO(_FN1), KC_LEFT, KC_DOWN, KC_RGHT),
    ...
    [WIN_BASE] = LAYOUT_ansi_73(
        ...
        _______, KC_LCTL, KC_LWIN,  KC_LALT,                             KC_SPC,                             KC_RALT,  MO(_FN2), MO(_FN1), KC_LEFT, KC_DOWN, KC_RGHT),
